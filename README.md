...
- 当前交付版本：`v0.3.3`
- 当前状态：已完成“孩子学习语音工作台 + 背诵/朗读学习素材自动补全 + 家长端移动 H5”阶段收口，可作为下一阶段前的稳定 GitHub 基线
- 版本对齐：根文档、`apps/parent-web/package.json`、`apps/pad-app/pubspec.yaml` 已统一到 `v0.3.3` 基线
...
- 用户操作手册：[docs/USER_MANUAL_V0.3.3.md](docs/USER_MANUAL_V0.3.3.md)
- 家长端移动 H5 操作手册：[docs/PARENT_WEB_H5_MANUAL.md](docs/PARENT_WEB_H5_MANUAL.md)
- 阶段一页摘要：[docs/26_PHASE_ONE_PAGER_V0.3.3.md](docs/26_PHASE_ONE_PAGER_V0.3.3.md)
- `v0.3.3` 发布说明：[docs/25_RELEASE_NOTES_V0.3.3.md](docs/25_RELEASE_NOTES_V0.3.3.md)
...
- `v0.3.1` 已作为上一版正式标签保留
- `v0.3.2` 已作为上一版正式标签保留
- `v0.3.3` 已作为当前正式标签和 GitHub release 基线同步
- 当前正式发版范围包括孩子学习语音工作台、学习素材自动补全、背诵分析能力，以及版本文档同步
